...
\newlength{\Rvolpre}\setlength{\Rvolpre}{1in}
\newlength{\Rchppre}\setlength{\Rchppre}{1cm}
\newlength{\Rsecpre}\setlength{\Rsecpre}{1cm}
\newlength{\Rsecpro}\setlength{\Rsecpro}{1cm}
\newlength{\Rsubpre}\setlength{\Rsubpre}{1em}
\newlength{\Rsubpro}\setlength{\Rsubpro}{1em}
...
\newcommand{\Rtocline}[5]{%
    ...
    \hyperlink{#5}{%
        ...
        \setlength{\Rtoclen}{\textwidth}%
        \addtolength{\Rtoclen}{-#1}%
        \addtolength{\Rtoclen}{-2cm}%
        \parbox[t]{\Rtoclen}{%
            \raggedright%
            #3%
            \rule[-0.5em]{0pt}{0.5em}%
        }
        \hfill%
        #4%
        \hspace*{1cm}%
